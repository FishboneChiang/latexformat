...
While it is far from a full LaTeX parser, it helped me format [my recently published paper](https://arxiv.org/abs/2603.18140) on arXiv and has been tested to handle medium- to large-size JHEP papers (around 50 to 100 pages) with ease. On my personal computer, such files are typically formatted in around 5 ~ 10 ms, while the feature-rich `latexindent` often takes several seconds.
